...
const variantStyles = {
  primary:
    'rounded-md bg-zinc-900 py-1 px-3 text-white hover:bg-zinc-700 dark:bg-indigo-400/10 dark:text-indigo-400 dark:ring-1 dark:ring-inset dark:ring-indigo-400/20 dark:hover:bg-indigo-400/10 dark:hover:text-indigo-300 dark:hover:ring-indigo-300',
  secondary:
  ...
  filled:
    'rounded-md bg-zinc-900 py-1 px-3 text-white hover:bg-zinc-700 dark:bg-indigo-500 dark:text-white dark:hover:bg-indigo-400',
  outline:
