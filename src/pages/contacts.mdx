...
## List all templates {{ tag: 'GET', label: '/v1/contacts' }}
...
## Create a template {{ tag: 'POST', label: '/v1/contacts' }}
...
## Retrieve a template {{ tag: 'GET', label: '/v1/contacts/:id' }}
...
## Update a template {{ tag: 'PUT', label: '/v1/contacts/:id' }}
...
## Delete a template {{ tag: 'DELETE', label: '/v1/contacts/:id' }}
